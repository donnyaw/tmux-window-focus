...
tmux bind-key -T tmux-window-bookmarks 1 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 1 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 2 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 2 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 3 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 3 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 4 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 4 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 5 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 5 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 6 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 6 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 7 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 7 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 8 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 8 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 9 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 9 '#{client_tty}'"
tmux bind-key -T tmux-window-bookmarks 0 run-shell -b "$SCRIPTS_DIR/bookmark-go.sh 10 '#{client_tty}'"
